...
Terminal: mongo > show dbs > use yelp;
...
db.business.find(
{
	"name": /.*pizza.*/i /* dung /pizza/i cung dung*/
}, 
{
	"_id": 0, 
	"name": 1,
...
db.business.find(
{
	"categories": { "$in": [ 'Restaurants' ] } /*what is different to /m/*/
}, 
{
	"_id": 0, 
	"name": 1,
...
/* -- dont need exclamation signs "" for operator)
-- $expr
What is new Date("")*/
